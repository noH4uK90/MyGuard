...
let project = Project(
    ...
    targets: [
        .target(
            ...
            destinations: .iOS,
            product: .framework,
            bundleId: "noh4uk.MyGuard.Passwords",
            ...
            scripts: [
                ...
                """, name: "Passwords Needle Generator",
                     inputPaths: ["$(SRCROOT)/Projects/Passwords/Sources/**"],
                     outputPaths: ["$(SRCROTT)/Projects/Passwords/Sources/Generator/NeedleGenerated.swift"]
                    )
            ],
            dependencies: [
