    ...
    targets: [
        .target(
            ...
            scripts: [
                ...
                """, name: "Auth Needle Generator",
                     inputPaths: ["$(SRCROOT)/Projects/Auth/Sources/**"],
                     outputPaths: ["$(SRCROTT)/Projects/Auth/Sources/Generator/NeedleGenerated.swift"]
                    )
            ],
            dependencies: [
