...
let project = Project(
    ...
    targets: [
        .target(
            ...
            destinations: .iOS,
            product: .framework,
            bundleId: "noh4uk.MyGuard.Profile",
            ...
            scripts: [
                ...
                """, name: "Profile Needle Generator",
                     inputPaths: ["$(SRCROOT)/Projects/Profile/Sources/**"],
                     outputPaths: ["$(SRCROTT)/Projects/Profile/Sources/Generator/NeedleGenerated.swift"]
                    )
            ],
            dependencies: [
